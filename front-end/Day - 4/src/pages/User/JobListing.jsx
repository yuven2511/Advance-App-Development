    ...
    return (
        <div>
           <div className="d-flex flex-row">
                <Link to="/home"><button className="mr-4 btn btn-info">Back</button></Link>
            </div>
                    ...
                    {[1, 2, 3, 4,5].map(jobId => (
                        <div key={jobId} className="card mt-4 p-3 shadow d-flex flex-column ">
                            ...
                            <div className="more-btn text-center d-flex flex-row">
                                <button className="text-center btn btn-success">Apply</button>
                                <button type="button" className="btn btn-info" onClick={() => handleModalToggle(jobId)}>
                                    More Info
                                </button>
                            </div>
                        </div>
