                    ...
                    {[101, 102, 103, 104, 105].map(jobPremiumId => (
                        <div key={jobPremiumId} className="card mt-4 p-3 shadow d-flex flex-column ">
                            ...
                            <div className="more-btn text-center d-flex flex-row">
                                <Link to="/payment"><button className="text-center btn btn-success">Apply</button></Link>
                                <button type="button" className="btn btn-info" onClick={() => handleModalToggle(jobPremiumId)}>
                                    More Info
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="modal-dialog" role="document">
                            <div className="modal-content">
                                ...
                                <div className="modal-footer">
                                    <button type="button" className="btn btn-info" onClick={() => handleModalToggle(null)}>Close</button>
                                </div>
                            </div>
                        </div>
                    </div>
